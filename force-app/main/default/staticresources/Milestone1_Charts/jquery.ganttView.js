    ...
    var Chart = {
        ...
        addVtHeader: function (div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                var dataName = new String(data[i].name); //Sanitize value before displaying on page
                var dataNode = document.createTextNode(dataName); //Sanitize value
                ...
                for (var j = 0; j < data[i].series.length; j++) {
                    var nameString = new String(data[i].series[j].name); //Sanitize value
                    var nameNode = document.createTextNode(nameString); //Sanitize value
